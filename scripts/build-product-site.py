...
*{box-sizing:border-box}html{scroll-behavior:smooth;max-width:100%}body{margin:0;max-width:100%;color:var(--ink);font-family:Inter,ui-sans-serif,system-ui,-apple-system,"Segoe UI",sans-serif;line-height:1.5;background:#fff}img,svg,video,canvas{max-width:100%;height:auto}a{text-decoration:none;color:inherit}button,input,textarea{font:inherit}.wrap{width:min(var(--max),calc(100% - 40px));margin:auto;min-width:0}
.site-header{position:sticky;top:0;z-index:40;background:rgba(255,255,255,.93);backdrop-filter:blur(18px);border-bottom:1px solid var(--line)}.header-row{height:72px;display:flex;align-items:center;gap:24px}.brand{margin-right:auto;min-width:0;display:flex;align-items:center}.vii-logo{height:34px!important;width:auto!important;max-width:190px!important;object-fit:contain}.brand-word{font-weight:900;letter-spacing:.08em;font-size:21px}.nav{display:flex;gap:20px;font-size:14px;font-weight:680}.nav a:hover,.text-link{color:var(--blue)}.header-actions{display:flex;align-items:center;gap:9px;flex:0 0 auto;min-width:0}.lang-link{font-size:12px;font-weight:850;border:1px solid var(--line);border-radius:9px;padding:8px 9px}.header-cta,.btn{display:inline-flex;max-width:100%;align-items:center;justify-content:center;border-radius:11px;padding:12px 17px;font-size:14px;font-weight:800;border:1px solid transparent;cursor:pointer}.header-cta,.btn-primary{background:var(--ink);color:#fff}.header-cta:hover,.btn-primary:hover{background:var(--blue)}.btn-secondary{border-color:#cbd6e4;background:#fff}.mobile-toggle{display:none;border:0;background:none;font-size:24px}
...
.grid2,.grid3,.grid4,.grid5,.case-grid,.offer-grid,.team-grid{display:grid;gap:15px}.grid2{grid-template-columns:repeat(2,minmax(0,1fr))}.grid3{grid-template-columns:repeat(3,minmax(0,1fr))}.grid4{grid-template-columns:repeat(4,minmax(0,1fr))}.grid5{grid-template-columns:repeat(5,minmax(0,1fr))}.case-grid{grid-template-columns:repeat(3,minmax(0,1fr))}.offer-grid{grid-template-columns:repeat(4,minmax(0,1fr))}.team-grid{grid-template-columns:repeat(2,minmax(0,1fr))}
...
.industry-browser{border:1px solid var(--line);border-radius:24px;background:#fff;overflow:hidden}.industry-tabs{display:flex;gap:7px;overflow:auto;padding:14px;border-bottom:1px solid var(--line);background:var(--soft)}.industry-tabs button{white-space:nowrap;border:1px solid #ccd7e4;background:#fff;border-radius:999px;padding:10px 15px;font-weight:800;cursor:pointer;color:#44546a}.industry-tabs button.active{background:var(--ink);color:#fff;border-color:var(--ink)}.industry-panel{padding:26px}.industry-panel-head{display:flex;justify-content:space-between;align-items:end;gap:24px;margin-bottom:20px}.industry-panel-head h3{font-size:30px;letter-spacing:-.03em;margin:0 0 5px}.industry-panel-head p{margin:0;color:var(--muted)}.module-buy-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px}.module-buy-card{display:flex;flex-direction:column;border:1px solid var(--line);border-radius:16px;padding:18px;background:#fff}.module-buy-card h4{font-size:18px;margin:0 0 7px}.module-buy-card p{font-size:13px;color:var(--muted);margin:0 0 14px}.module-buy-meta{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:7px;margin-top:auto}.module-buy-meta div{background:var(--soft);border-radius:9px;padding:9px}.module-buy-meta small{display:block;font-size:9px;color:#7a8797;text-transform:uppercase;letter-spacing:.06em}.module-buy-meta b{font-size:12px}.module-buy-card .text-link{margin-top:13px}.module-buy-card,.product-card,.case-card,.team-person,.industry-panel,.scope-box,.lead-form,.special-box,.compare-box{min-width:0}.module-buy-meta b,.scope-meta strong,.team-person .role,.text-link{overflow-wrap:anywhere}.trust-team{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:16px}.team-person{display:grid;grid-template-columns:150px 1fr;gap:20px;align-items:center;border:1px solid var(--line);border-radius:22px;padding:18px;background:#fff}.team-photo{width:150px;height:150px;border-radius:16px;object-fit:cover;display:block}.team-person h3{font-size:24px;margin:3px 0 7px}.team-person .role{font-weight:800;font-size:13px}.team-person p{font-size:13px;color:var(--muted);margin:8px 0 0}.trust-box{margin-top:18px;border-radius:20px;background:#edf4ff;border:1px solid #d3e0fb;padding:22px}.trust-box h3{margin:0 0 14px;font-size:22px}.trust-list{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.trust-item{padding:13px 14px;border-radius:12px;background:#fff;font-size:13px;font-weight:700}.buy-steps{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:10px}.buy-step{border:1px solid var(--line);border-radius:15px;padding:16px;background:#fff}.buy-step b{display:block;margin-bottom:6px}.buy-step span{font-size:12px;color:var(--muted)}.hero-safety{border-radius:26px;padding:25px;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.15)}.hero-safety h3{font-size:19px;margin:0 0 16px}.hero-safety ul{list-style:none;margin:0;padding:0}.hero-safety li{padding:12px 0;border-top:1px solid rgba(255,255,255,.12);font-size:14px;color:#d3dfec}.hero-safety li:before{content:"✓";display:inline-block;margin-right:9px;color:#78d9b7;font-weight:900}.module-steps{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:10px}.module-step{border:1px solid var(--line);border-radius:14px;padding:15px;background:#fff}.module-step .num{display:block;color:var(--blue);font-size:11px;font-weight:900;margin-bottom:7px}
...
.badges{display:flex;gap:6px;flex-wrap:wrap;margin-top:13px}.badge{font-size:11px;font-weight:720;background:#eef2f7;color:#526177;border-radius:999px;padding:5px 8px}.case-card{display:flex;flex-direction:column;min-height:265px}.case-top{display:flex;justify-content:space-between;gap:15px;flex-wrap:wrap}.case-card .actions{display:flex}
...
.matrix-wrap{display:grid;grid-template-columns:240px minmax(0,1fr);gap:24px}.matrix-tabs{display:flex;flex-direction:column;gap:8px}.matrix-tabs button{border:1px solid var(--line);background:#fff;border-radius:11px;padding:12px;text-align:left;font-weight:760;cursor:pointer}.matrix-tabs button.active{background:var(--ink);color:#fff;border-color:var(--ink)}.matrix-results{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:11px}.matrix-result{border:1px solid var(--line);border-radius:15px;padding:17px;background:#fff}.matrix-result.hidden{display:none}.matrix-result b{display:block}.matrix-result span{font-size:12px;color:var(--muted)}
...
.two-col{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:36px}.list-clean{list-style:none;padding:0;margin:0}.list-clean li{padding:13px 0;border-bottom:1px solid var(--line)}.quote{font-size:25px;line-height:1.32;letter-spacing:-.02em;border-left:4px solid var(--blue);padding-left:20px}.compare{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:18px}.compare-box{border-radius:19px;padding:24px;border:1px solid var(--line);background:#fff}.compare-box.after{background:#f1f6ff;border-color:#cad9fb}.compare-box h3{margin-top:0}.compare-box li{margin-bottom:9px;color:var(--muted)}
.module-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:13px}.module{border:1px solid var(--line);border-radius:16px;padding:19px;background:#fff}.module h3{font-size:17px;margin:0 0 8px}.module p{font-size:13px;color:var(--muted);margin:0}
.scope-box{border-radius:22px;padding:26px;background:#f0f4fa;border:1px solid #d7e0eb}.scope-meta{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px;margin:18px 0}.scope-meta div{background:#fff;border-radius:13px;padding:15px}.scope-meta small{display:block;color:#778598;text-transform:uppercase;letter-spacing:.08em;font-size:10px}.scope-meta strong{display:block;margin-top:4px;font-size:16px}.scope-list{padding-left:20px}.scope-list li{margin-bottom:8px}
.industry-flow{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:10px}.industry-step{border:1px solid var(--line);border-radius:14px;padding:15px;background:#fff;font-size:13px;font-weight:750;position:relative}.industry-step:not(:last-child):after{content:"→";position:absolute;right:-9px;top:50%;z-index:2;color:#75869a}
...
def contact(lang, default_interest=""):
    ...
    return f'''<section class="contact-bar" id="contact"><div class="wrap contact-layout">
      ...
      <form class="lead-form" data-contact="{target}" data-default-interest="{escape(default_interest)}">
        ...
        <input type="hidden" name="interest"><input type="hidden" name="page_context"><input type="text" name="website" tabindex="-1" autocomplete="off" aria-hidden="true" style="position:fixed;top:0;left:0;width:1px;height:1px;padding:0;border:0;opacity:0;pointer-events:none;clip-path:inset(50%)">
